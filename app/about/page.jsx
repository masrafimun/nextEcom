...
const About = () => {
  return (
    <div className="container mx-auto">
      ...
      <div className="my-10 mx-6 sm:mx-0 flex flex-col md:flex-row gap-16">
        <img
      ...
      <div className="text-xl py-4 mx-6 sm:mx-0">
         <div className="inline-flex gap-2 items-center mb-3">
      ...
      <div className="flex flex-col md:flex-row text-sm mb-20">
        <div className="border text-gray-600  px-7 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
        ...
        <div className="border px-7 md:px-16 py-8 sm:py-20 text-gray-600  flex flex-col gap-5">
          <b>Convenience</b>
          <p>
